# Developing EDD Composer Extension

This guide covers local development, testing, CI, and releases. For store installation and setup, see the [README](README.md).
